    ...
    <div className="flex flex-col h-[110vh] bg-gradient-to-r from-purple-700 to-blue-500 bg-cover bg-center bg-no-repeat text-white overflow-x-hidden">
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-600 bg-opacity-75 z-50">
          <div className="bg-white text-blue-700 p-6 rounded-lg shadow-lg w-11/12 md:w-1/2">
            <div className="relative">
              ...
              {step1Completed && step2Completed && step3Completed ? (
                <p className="text-lg font-semibold">
                  ...
                  <a href="https://www.canva.com/brand/join?token=JkkkZ4CaA0bbSyjqvJ8lZw&referrer=team-invite" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">
                    CANVA PRO GRATUIT : Cliquez ici pour accéder
                  </a>
                </p>
              ) : (
                <p className="text-lg font-semibold">
                  Complétez toutes les étapes pour obtenir le lien !
                </p>
              )}
            </div>
          </div>
